...
#   6. GitHub release — gh release create --target main (auto-bump tag + apkg)
#                        → fetch the remote tag for the next version bump
#
...
echo "==> [5/6] Creating GitHub release (--target main: tag points at the pushed commit)"
